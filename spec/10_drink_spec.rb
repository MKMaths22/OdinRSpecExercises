...
describe Drink do
  describe '#initialize' do
    context 'when type is specified and ounces is default' do
      ...
      it 'is your choice of beverage' do
        expect(subject.type).to eql('water')
      end

      # remove the 'x' before running this test
      it 'has 16 ounces' do
        expect(subject.ounces).to eql(16)
      end
    end
  end
  ...
  describe '#full?' do
    context 'when drink has 16 ounces or more' do
      subject(:default_drink) { described_class.new('tea') }
      # remove the 'x' before running this test
      it 'is full' do
    ...
    context 'when drink has less than 16 ounces' do
      subject(:my_drink) { described_class.new('orange juice', 8) }
